...
test('MdParser headlines', function(t) {
	var expected = [
		{ text: "Main Headline", level: 1, row: 3, column: 1 },
		{ text: "Subsection", level: 2, row: 6, column: 1 },
		{ text: "(01) Headline {#first_hl}", level: 1, row: 15, column: 1 },
		{ text: "1.2 _Headline_ **2**", level: 2, row: 17, column: 1 },
		{ text: "Headline <http://www.endoftheinternet.com/>", level: 3, row: 20, column: 1 },
		{ text: "Headline [hl1](#first_hl), [hl1][(01) Headline], [(01) Headline][], [(01) Headline] - []", level: 1, row: 22, column: 1 },
		{ text: "the last headline", level: 4, row: 28, column: 1 }
	];
